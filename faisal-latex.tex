...
\newcommand{\program}[1]{\begin{center}\color{myblue}\small{#1}\end{center}}
...
\program{Software Developer -- Electrical and Electronics Engineer Major -- Indian Institute of Technology, Ropar}
...
\begin{resume_section}{\color{myblue}About Me}
  ...
  \textbf{Interests} \> Mobile apps, Physics, Tennis\\*
  \end{nospacetabbing}
